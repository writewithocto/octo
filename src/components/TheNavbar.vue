<template>
  <nav class="relative flex flex-wrap items-center content-between py-3 px-4 z-index-10 md:hidden p-6 w-full">
    ...
    <div class="flex items-stretch fixed top-3 right-3">
      <router-link class="inline-block align-middle text-center select-none border font-normal whitespace-no-wrap rounded py-1 px-3 leading-normal no-underline bg-gray-600 text-white hover:bg-gray-700 flex justify-between items-center" :to="{ name: 'tags' }">
      ...
      <router-link class="inline-block align-middle text-center select-none border font-normal whitespace-no-wrap rounded py-1 px-3 leading-normal no-underline bg-gray-600 text-white hover:bg-gray-700 flex justify-between items-center ml-2" :to="{ name: 'menu' }" role="button" aria-haspopup="true" aria-expanded="false">
      ...
      <router-link v-if="isDashboard" :to="{ name: 'quick-action' }" class="inline-block align-middle text-center select-none border font-normal whitespace-no-wrap rounded py-1 px-3 leading-normal no-underline bg-gray-600 text-white hover:bg-gray-700 flex justify-between items-center ml-2">
      ...
      <router-link v-else-if="isDocument" :to="{ name: 'document-meta', params: { id: document.id } }" class="inline-block align-middle text-center select-none border font-normal whitespace-no-wrap rounded py-1 px-3 leading-normal no-underline bg-gray-600 text-white hover:bg-gray-700 flex justify-between items-center ml-2">
      ...
      <button v-else @click="close" class="inline-block align-middle text-center select-none border font-normal whitespace-no-wrap rounded py-1 px-3 leading-normal no-underline bg-gray-600 text-white hover:bg-gray-700 flex justify-between items-center ml-2">
